...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo mr-auto"><a href="" style="font-family:Roboto Slab; font-weight:bolder" style="color:#33150e;"></a></h1>
            ...
            <a href="" class="get-started-btn" style="background-color: #261412;">Masuk</a>
        ...
        <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9 text-center">
                    <img src="kap.png" class="mx-auto" style="width: 300px; margin:auto" class="img-fluid" alt=""><br>
                    <small style="font-style: italic;">Kapolda Bengkulu: Irjen. Pol. Drs. Guntur Setyanto, M.Si</small>
                    <h1 style="color:#33150e;font-family:ar">Selamat datang di sistem e-PPP!</h1>
                    <h2>Biro SDM Polda Bengkulu</h2>
                </div>
            </div>
            <div class="text-center">
                <a href="http://localhost:8080/kp_polda/auth" class="btn-get-started" style="background-color: #261412;">Masuk</a>
            </div>
        </div>
    </section><!-- End Hero -->
        ...
        <section id="informasi" class="informasi">
            <div class="container" data-aos="fade-up">
                <div class="section-title">
                    ...
                    <p><i style="font-weight: bold;">n.</i> sekumpulan data atau fakta yang diorganisasi atau diolah dengan cara tertentu sehingga mempunyai arti bagi penerima</p>
                </div>
                <div class="row">
                    <div class="col-lg-6 video-box align-self-baseline" data-aos="fade-right" data-aos-delay="100">
                        <img src="logoeppp.png" class="mx-auto" style="width: 500px; margin:auto" class="img-fluid" alt=""><br>
                    </div>
            ...
            <section id="berita" class="berita">
                <div class="container" data-aos="fade-up">
                    <div class="section-title">
                        ...
                        <p> <i style="font-weight: bold;">n.</i> cerita atau keterangan mengenai kejadian atau peristiwa yang hangat; kabar; pemberitahuan; pengumuman </p>
                    </div>
                    <div class="row row-cols-1 row-cols-md-2 my-5 mx-3">
                        ...
                        <div class="col mb-6 mt-4">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <h2 class="card-title text-center" style="font-size: 23px; font-weight:bolder">{{ $ber->judul }}</h2>
                                    <p class="card-text">{{ $ber->isi }}</p>
                                </div>
                            </div>
                        </div>
                        @endforeach
        ...
        <footer id="footer">
            <div class="container d-md-flex py-4">
                ...
                <div class="social-links text-center text-md-right pt-3 pt-md-0">
                    <a href="https://twitter.com/poldabengkulu" target="_blank" style="background-color: #bb9457;" class="twitter"><i class="bx bxl-twitter"></i></a>
                    <a href="https://www.facebook.com/PoldaBengkulucamkoha" target="_blank" style="background-color: #bb9457;" class="facebook"><i class="bx bxl-facebook"></i></a>
                    <a href="https://www.instagram.com/polda_bengkulu/" target="_blank" style="background-color: #bb9457;" class="instagram"><i class="bx bxl-instagram"></i></a>
                </div>
            </div>
        </footer><!-- End Footer -->
