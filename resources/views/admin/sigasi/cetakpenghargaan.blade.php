...
<body>
    <div class="page">
        ...
        <div class="container">
            ...
            <center>
                <h3>Rekap Data Penghargaan Personel</h3>
            </center>
            <table border="1">
                <tr>
                    <th style="width:5px">
                ...
                <tr style="width:1000px">
                    ...
                    <td style="width:100px;text-align:justify" valign="top">{{ $dg->nama_penghargaan}}</td>
                    <td style="width:100px;text-align:justify" valign="top">{{ $dg->sumber}}</td>
                    <td style="width:100px;text-align:justify" valign="top">{{ $dg->keterangan_penghargaan}}</td>
