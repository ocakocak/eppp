                    ...
                    <div class="card-body p-0">
                        <form action="{{ route('updatepersonil', $data_personil->id_personil) }}" method="post"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="row ml-1" style="height:40px">
                                                    <select class="select" id="id_pangkat" name="id_pangkat">
                                                        <div>
                            ...
                            <div class="card-footer text-right">
                                <button class="btn btn-polda mr-1" type="submit"><i class="fas fa-save"></i></button>
        ...
        <script>
            $(document).ready(function () {
                $('#jenis_penghargaan').summernote({
                    placeholder: value = "{!!$data_personil->jenis_penghargaan!!}",
                    height: '400'
                });
            });
